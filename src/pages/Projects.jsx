    ...
    <div className="relative isolate pt-32 bg-gray-100 dark:bg-zinc-950 transition-colors duration-300">
      <div className="mx-auto max-w-5xl px-6 lg:px-8 pb-24">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-4xl font-bold text-zinc-900 dark:text-white sm:text-6xl mb-6 transition-colors duration-300">
            Proven <span className="text-amber-500">Solutions.</span>
          </h1>
          <p className="text-zinc-600 dark:text-zinc-400 text-lg max-w-2xl leading-relaxed transition-colors duration-300">
