      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="mx-auto max-w-2xl pt-32 pb-16 sm:pt-48 sm:pb-24 lg:pt-56 lg:pb-32">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-zinc-300 sm:text-xl/8">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a
                href="#about"
                className="text-sm/6 font-semibold text-white border border-zinc-700 px-3.5 py-2.5 rounded-md hover:bg-zinc-800 transition-all"
              >
