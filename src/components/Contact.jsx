    ...
    <section id="contact" className="py-24">
      <div className="mx-auto max-w-5xl px-6 lg:px-8 text-center">
        ...
        <p className="text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <span className="font-bold text-zinc-200">TS/SCI cleared</span>{" "}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="w-full sm:w-auto border border-zinc-700 hover:border-amber-500/50 hover:bg-zinc-800 text-zinc-300 font-bold py-4 px-10 rounded-md transition-all"
          >
            Direct Email
          </a>
        </div>
        ...
        <Transition show={isOpen} as="div">
          <Dialog onClose={() => setIsOpen(false)} className="relative z-[100]">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
              ...
              >
                <DialogPanel className="w-full max-w-md rounded-2xl bg-zinc-900 p-8 border border-zinc-800 shadow-2xl">
                  ...
                  {/* Note: Update the action URL to your actual form endpoint */}
                  <form
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        name="email"
                        required
                        className="w-full bg-zinc-800 border border-zinc-700 rounded-md py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 mb-2">
