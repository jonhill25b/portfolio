      ...
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative aspect-square rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden transition-colors duration-300">
              <img
                src={ProfilePicture}
                alt="Jonathan Hill"
          ...
          {/* Right Side: Content */}
          <div>
            <h2 className="text-xs font-bold tracking-[0.2em] text-zinc-500 dark:text-zinc-500 uppercase mb-4">
              Behind the Code
            </h2>
            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white mb-6 transition-colors duration-300">
              Bridging Military Precision with{" "}
              <span className="text-amber-500">Technical Innovation.</span>
            </h3>
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6 transition-colors duration-300">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-zinc-700 dark:text-zinc-300 text-sm transition-colors duration-300">
                  Managed secure access for{" "}
                  <span className="font-bold text-zinc-900 dark:text-zinc-100">4,000+ users</span>{" "}
                  while maintaining a{" "}
